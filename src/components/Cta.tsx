...
import { ArrowRight, Smartphone, Users, Clock, Shield } from "lucide-react"

export default function Cta() {
  const stats = [
    { value: "10K+", label: "Devices Repaired", icon: Users },
    { value: "30min", label: "Average Repair", icon: Clock },
    { value: "98%", label: "Success Rate", icon: Shield },
    { value: "24/7", label: "Emergency Service", icon: Smartphone }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Get your phone, tablet, or device fixed by certified technicians today. 
                Fast, reliable repairs with lifetime warranty included.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Complete device assessment at no charge
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                All repairs covered with comprehensive warranty
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Most repairs completed in 30 minutes or less
              </p>
            </div>
          </div>
        </div>
